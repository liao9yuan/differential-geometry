import RicciFlower.Tensor.RSTensor.NablaOnTensors.Model
...
/-- Smoothness of the `(1,0)` covariant derivative.

This is the vector-field base case for tensor covariant-derivative regularity:
under mathlib's smooth-connection hypothesis, `p ↦ (∇_X Y)(p)` is a smooth
