...
/-!
# Fixed-chart tensor representatives for covariant derivatives

This module contains the fixed-chart tensor representatives and smoothness lemmas used by the
regularity route for `nabla0SFun`.
-/
