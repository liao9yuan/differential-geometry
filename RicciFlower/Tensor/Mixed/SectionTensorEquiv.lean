...
-/
import RicciFlower.Tensor.Mixed.Field
import RicciFlower.Tensor.Mixed.DualFiber
import RicciFlower.Tensor.Mixed.Naturality
import RicciFlower.Tensor.Product.Section
import RicciFlower.Tensor.Product.HomEquiv
/-!
...
`Φ : F ≃L[𝕜] F` (proved in `RicciFlower.Tensor.Mixed.Naturality`). -/
