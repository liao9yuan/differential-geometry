...
`component_le_sqrt` and `trace_normSq_le` are proved and focused-check green.
The latter bounds the squared norm of the first-two-slot metric trace by an
explicit finite-dimensional multiple of the squared norm of the source tensor.
