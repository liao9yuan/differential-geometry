...
noncomputable def fderivTensor0S (α : E → ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜)
    (x : E) : E →L[𝕜] ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜 :=
  fderiv 𝕜 α x
...
noncomputable def vectorFieldActionOnTensor0S
    (X : E → E) (α : E → ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜) (x : E) :
...
noncomputable def substituteArg (s : ℕ) (i : Fin s)
    (α : ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜)
    (f : E →L[𝕜] E) :
    ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜 :=
...
noncomputable def lieDeriv_correction (s : ℕ)
    (DX : E →L[𝕜] E) (α : ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜) :
    ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜 :=
...
noncomputable def lieDeriv_tensor0SWithin (s : ℕ)
    (X : E → E) (α : E → ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜) (t : Set E) (x : E) :
    ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜 :=
...
abbrev Tensor0SBundle (s : ℕ) (I : ModelWithCorners 𝕜 E H) (M : Type*)
  ...
  TotalSpace (ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜) (fun x : M => Tensor0SSpace s I x)
...
noncomputable def mlieDeriv_tensor0SWithin (s : ℕ)
  ...
  -- Since TangentSpace I x = E definitionally, Tensor0SSpace s I x = ContinuousMultilinearMap ...
  let α' : E → ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜 := fun y =>
...
lemma lieDeriv_correction_add (DX : E →L[𝕜] E)
    (α β : ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜) :
...
lemma lieDeriv_correction_zero (DX : E →L[𝕜] E)
    (α : ContinuousMultilinearMap 𝕜 (fun _ : Fin 0 => E) 𝕜) :
...
noncomputable def lieDeriv_tensorRSWithin (r s : ℕ)
    (X : E → E)
    (T : E → ContinuousMultilinearMap 𝕜 (fun _ : Fin r => E) 𝕜 →L[𝕜] ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜)
    (t : Set E) (x : E) :
    ContinuousMultilinearMap 𝕜 (fun _ : Fin r => E) 𝕜 →L[𝕜] ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜 :=
...
noncomputable def mlieDeriv_tensorRSWithin (r s : ℕ) {m : WithTop ℕ∞}
  ...
  { toFun := fun x₀ => by
      ...
      let T' : E → ContinuousMultilinearMap 𝕜 (fun _ : Fin r => E) 𝕜 →L[𝕜] ContinuousMultilinearMap 𝕜 (fun _ : Fin s => E) 𝕜 :=
