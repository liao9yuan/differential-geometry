...
/-!
# Compression of finite monotone subdivisions

This file removes zero-length pieces from a finite monotone subdivision while
retaining the original positive segment that realizes every compressed piece.
-/
...
/-- A finite monotone subdivision can be compressed to a strict subdivision.
Every compressed segment records the original positive segment with exactly
the same two endpoint values. -/
