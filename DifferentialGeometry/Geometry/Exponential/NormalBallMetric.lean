...
@[simp] theorem accel_zero (g : SmoothRiemannianMetric I M) {p : M}
  ...
  unfold accel
  change -((_root_.DifferentialGeometry.Integral.Connection.leviCivitaConnectionOfMetric
      (I := modelWithCornersSelf Real E)
      (c.totalMetric g) (fun _ : E => (0 : E)) (0 : E)) (0 : E)) = 0
  rw [_root_.DifferentialGeometry.Integral.Connection.leviCivitaConnectionOfMetric_apply]
  have hz :
      _root_.DifferentialGeometry.Integral.Connection.leviCivitaConnectionCandidateAt
          (I := modelWithCornersSelf Real E)
