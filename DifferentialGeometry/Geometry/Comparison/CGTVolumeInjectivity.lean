import DifferentialGeometry.Geometry.Comparison.CGTInjectivity
...
/-- A lower bound for a metric ball, together with ambient curvature and
model-volume control, gives an explicit lower bound for the intrinsic injectivity radius. -/
