...
/-- A finite-endpoint geodesic with a metric-topology limit admits a local continuation. -/
...
attribute [-instance] Tensor0SBundle.tangentSpace_normedAddCommGroup
  Tensor0SBundle.tangentSpace_normedSpace in
/-- A bounded-speed geodesic on a complete space admits a finite-endpoint continuation. -/
...
attribute [-instance] Tensor0SBundle.tangentSpace_normedAddCommGroup
  Tensor0SBundle.tangentSpace_normedSpace in
omit [CompleteSpace M] in
/-- A bounded-speed geodesic confined near its endpoint to a compact set continues locally. -/
