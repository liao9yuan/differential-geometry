...
/-- A failure of radial Ricci saturation makes the exponential Jacobian strictly
smaller than its model-density upper bound. -/
...
attribute [-instance] Tensor0SBundle.tangentSpace_normedAddCommGroup
  Tensor0SBundle.tangentSpace_normedSpace in
/-- Strictly positive Ricci curvature makes the zero-curvature segment-ball
volume comparison strict. -/
