...
/-- Strictly positive Ricci curvature makes an intrinsic ball strictly smaller
than its Euclidean comparison ball. -/
...
attribute [-instance] Tensor0SBundle.tangentSpace_normedAddCommGroup
  Tensor0SBundle.tangentSpace_normedSpace in
/-- Strictly positive sectional curvature makes an intrinsic ball strictly
smaller than its Euclidean comparison ball. -/
