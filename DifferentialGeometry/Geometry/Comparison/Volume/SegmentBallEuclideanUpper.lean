...
/-- The zero-curvature polar model over a metric tangent ball is exactly the
canonical Euclidean ball volume. -/
theorem gBall_model_eucl [ConnectedSpace M] [PseudoEMetricSpace M]
...
attribute [-instance] Tensor0SBundle.tangentSpace_normedAddCommGroup
  Tensor0SBundle.tangentSpace_normedSpace in
/-- Under nonnegative Ricci curvature, intrinsic ball volume has Euclidean
power-law relative growth. -/
