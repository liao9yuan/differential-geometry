...
attribute [-instance] Tensor0SBundle.tangentSpace_normedAddCommGroup
  Tensor0SBundle.tangentSpace_normedSpace in
/-- At sufficiently small radii, intrinsic ball volume is within any prescribed
multiplicative error of its pole-density Euclidean model. -/
...
attribute [-instance] Tensor0SBundle.tangentSpace_normedAddCommGroup
  Tensor0SBundle.tangentSpace_normedSpace in
/-- At sufficiently small radii, intrinsic ball volume is within any prescribed
multiplicative error of the Euclidean ball volume at the same scale. -/
