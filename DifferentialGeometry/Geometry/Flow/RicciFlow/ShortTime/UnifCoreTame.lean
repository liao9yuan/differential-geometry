...
theorem smoothN_h1_unif
  ...
  obtain ⟨ρ, Ctop, B0, B1, hρ, hCtop, hB0, hB1, hrem⟩ :=
    rem_h1_unif (I := I) (M := M) hDim gBase hΛ hδ₀_nonneg hδ₀_lt
...
theorem coreN_tame_unif
    ...
    ∃ ρ Ctop : ℝ, ∃ B0 B1 : ℝ → ℝ,
      ...
      ∀ g : SmoothRiemannianMetric I M,
        ...
        ∀ {R : ℝ} (_hR : 0 ≤ R) (_hRρ : R ≤ ρ)
          ...
          ‖coreN (I := I) (M := M) g gBase hδ₀_lt hreal x -
              coreN (I := I) (M := M) g gBase hδ₀_lt hreal y‖ ≤
            Ctop * R *
  ...
  obtain ⟨ρ, Ctop, B0, B1, hρ, hCtop, hB0, hB1, hsmooth⟩ :=
    smoothN_h1_unif (I := I) (M := M) hDim gBase hΛ hδ₀_nonneg hδ₀_lt
  refine ⟨ρ, Ctop, B0, B1, hρ, hCtop, hB0, hB1, ?_⟩
