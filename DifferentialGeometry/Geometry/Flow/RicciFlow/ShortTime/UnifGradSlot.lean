...
private noncomputable def gradSlotGridC (C₀ C₁ : ℝ) (i : ℕ) : ℝ :=
...
theorem gradSlot_grid_unif
  ...
  · intro g hEq hjet i hi x
    ...
    · have hR₀ := unifCurvSup_of (I := I) (M := M)
      ...
      have hz := gradSlot_rfns_zero (I := I) (M := M) g hC₀ hR₀ x
      rw [hDim] at hz
    ...
    · have hR₁ := unifRmOpOne_of (I := I) (M := M)
      ...
      have ho := gradSlot_rfns_one (I := I) (M := M) g hC₁ hR₁ x
      rw [hDim] at ho
