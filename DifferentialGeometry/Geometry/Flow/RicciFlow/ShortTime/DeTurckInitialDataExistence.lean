...
theorem deTurckRicci_solution_with_jointReg
  ...
  have hRepr : ∀ (S : SmoothCcTensor g₀ 0 2) {δ : ℝ} (hδ_lt : δ < 1)
      ...
      ccTensorBilinSymm (I := I) g₀
          (deTurckSmoothRemainder (I := I) (M := M) g₀ g_bg S hδ_lt hδ +
    ...
    set gDT := tensorSectionRealizeMetric (I := I) g₀ S hδ_lt hδ with hgDT_def
    set R : SmoothCcTensor g₀ 0 2 :=
      ...
      with hR_def
    have hsum_eq : deTurckSmoothRemainder (I := I) (M := M) g₀ g_bg S hδ_lt hδ +
