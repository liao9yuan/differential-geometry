...
open DifferentialGeometry.Analysis.Sobolev
  (deTurckLieDLbCoeffField iteratedCovGrad rsDomDomCongrSection
    rsDomDomCongrSection_toSection
    tensorL2Norm_sq_toFun_eq_integral_riemannianFiberNormSq_rs)
open DifferentialGeometry.Analysis.Spectral
  (appCcRS appCcRS_sub_left covGrad_sub lc0Insert nEndo_diff
    rfns_iteratedCovGrad_covGrad_comm_rs rsDomDomCongr toModel_rsDomDomCongr_apply)
open DifferentialGeometry.Analysis.Spectral.LieCorr0Core
  (lieCorr0InsertFib lieCorr0InsertFib_toModel lieCorr0NEndo)
