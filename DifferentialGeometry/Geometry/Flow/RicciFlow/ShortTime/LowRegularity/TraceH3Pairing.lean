...
open DifferentialGeometry.Analysis.Sobolev (gInvDiffRaisedEndoField iteratedCovGrad
  gInvDiffSlotCoeff_eq_slotInsertEndoCc normSq_le_integral_of_pointwise_fiberNormSq_le_rs
  rfns_iteratedCovGrad_rsDomDomCongr_both_eq rfns_iteratedCovGrad_slotInsertEndoCc_le_endo
  tensorL2Norm_sq_toFun_eq_integral_riemannianFiberNormSq_rs)
open DifferentialGeometry.Analysis.Sobolev.TensorHilbert
open DifferentialGeometry.Analysis.Spectral (appCcRS appCcRS_sub_right covGrad_appCcRS_eq
  fullRaisedEndoField gInvDiffSlotCoeff norm_iteratedCovGrad_domDomCongrSection pureTrace pureTrace_split
  rfns_iteratedCovGrad_covGrad_comm_rs rfns_iteratedCovGrad_slotExtend_le
  rfns_symmS_zero_le_fibreSmall slotExtend
...
private theorem insert_succ_l2
  ...
  have hpt : ∀ x : M,
    ...
    have heq :
      ...
      rw [DifferentialGeometry.Analysis.Spectral.CurvatureCoefficientDifferenceJetTower.tsSlotInsertEndoCc_succ_eq_reindex_slotExtend
        (I := I) (M := M) g s Λ]
