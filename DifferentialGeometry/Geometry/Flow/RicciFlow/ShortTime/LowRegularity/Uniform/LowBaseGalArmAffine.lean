...
import DifferentialGeometry.Geometry.Flow.RicciFlow.ShortTime.LowRegularity.Uniform.LowBaseA2Affine
...
theorem gal_arm_mass_affine_unif
            ...
            ∀ m : ℕ,
              Real.sqrt (∑ i ∈ F,
                tensorSobolevWeight (I := I) (M := M) i (m : ℝ) *
                  ((galArmVecBg (I := I) (M := M) g gBase hR0
  ...
  have hδZ : gFibreOpBound (I := I) (M := M) g
    ...
    lowregFibZero (I := I) (M := M) g hR0 hreal
