import DifferentialGeometry.Geometry.Flow.RicciFlow.ShortTime.LowRegularity.Uniform.GalerkinH3
...
theorem lowregProjMode_state_bound
  ...
  have hUcont : ∀ i ∈ eigenIdxFinset (I := I) (M := M) g N,
    ...
    fun i _ => lowregProjMode_cont (I := I) (M := M) g hT.le fseq N i
  ...
  have hcombo := lowregFieldCombo (I := I) (M := M) g hT hT1 N fseq u hnem
