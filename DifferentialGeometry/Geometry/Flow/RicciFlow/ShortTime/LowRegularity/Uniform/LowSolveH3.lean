import DifferentialGeometry.Geometry.Flow.RicciFlow.ShortTime.LowRegularity.Uniform.LowBoundsSmall
...
theorem lowreg_solve_h3_unif
  ...
  obtain ⟨delta, R0, hdelta, hdeltathird, hR0, _hR0one, hpair⟩ :=
    gal_arm_pair3_unif_of_mem (I := I) (M := M) hDim gBase hΛ one_pos
  ...
  obtain ⟨Φ, hΦ⟩ :=
    lowregFatouE3AtBg_of_pair (I := I) (M := M) g gBase hT hT1
