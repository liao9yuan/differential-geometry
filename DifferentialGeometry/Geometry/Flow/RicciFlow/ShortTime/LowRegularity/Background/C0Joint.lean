...
open DifferentialGeometry.Analysis.Sobolev
  (armSlotEndoCc_toSection armSlotFib armSlotFib_apply_eval metricConnDiffLoweredCc
   rsDomDomCongrSection_toSection)
open DifferentialGeometry.Analysis.Sobolev.TensorHilbert
open DifferentialGeometry.Analysis.Spectral
  (appCc appCc_add_left appCc_assoc appCc_smul_right appCc_toSection appCcRS appCcRS_smul_right
   appCcRS_sub_right appCcRS_toSection appCcRS_zero_eq_appCc edgeLiePairFam fullRaisedEndoField
...
private abbrev lieCorr0VBPerm :=
  DifferentialGeometry.Analysis.Spectral.LieCorr0Core.lieCorr0VBPerm
...
theorem traceRF_c0j
  ...
  rw [show
      ((lc0TraceRF (I := I) (M := M) g
        (realizedFam (I := I) g T 0 hδ hδZ q.2) p σ).toSection q.1)
          (Y q.1) =
        DifferentialGeometry.Analysis.Spectral.LieCorr0Core.lieCorr0TraceStep (I := I)
    ...
    DifferentialGeometry.Analysis.Spectral.LieCorr0Core.lieCorr0TraceStep,
