import DifferentialGeometry.Geometry.Flow.RicciFlow.ShortTime.LowRegularity.Background.C0Integrate
...
open DifferentialGeometry.Analysis.Spectral
  (appCc appCc_add_left ccTensorToHs ccTensorToHs_coeff phiMetCurvCoeff)
