import DifferentialGeometry.Geometry.Flow.RicciFlow.ShortTime.LowRegularity.Background.C0Core
...
open DifferentialGeometry.Analysis.Spectral
  (appCcRS_zero_eq_appCc appCcRS_zero_left ccTensorToHs ccTensorToHs_smul
