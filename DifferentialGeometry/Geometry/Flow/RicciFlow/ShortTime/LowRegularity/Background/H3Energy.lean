...
import DifferentialGeometry.Geometry.Flow.RicciFlow.ShortTime.LowRegularity.Background.ForceArms
...
private noncomputable def armLadder3BgA2Inputs
    (hDim : Module.finrank ℝ E = 3)
    (g g_bg : SmoothRiemannianMetric I M) :=
  a2PerIdxLin (I := I) (M := M) hDim g g_bg

private noncomputable def armLadder3BgA1Inputs
    (hDim : Module.finrank ℝ E = 3)
    (g g_bg : SmoothRiemannianMetric I M) :=
...
theorem armLadder3Bg (hDim : Module.finrank ℝ E = 3)
  ...
  obtain ⟨Cqa, Ka, hCqa, hKa, ha2⟩ :=
    armLadder3BgA2Inputs (I := I) (M := M) hDim g g_bg
  obtain ⟨Cqb, Kb0, Kb1, hCqb, hKb0, hKb1, ha1⟩ :=
    armLadder3BgA1Inputs (I := I) (M := M) hDim g g_bg
