import DifferentialGeometry.Geometry.Flow.RicciFlow.ShortTime.LowRegularity.Background.C0Estimate
...
open DifferentialGeometry.Analysis.Spectral
  (appCc appCc_add_left ccTensorToHs ccToHsLin ccToHsLin_apply
