...
order-three top grid.  The resulting affine `H1` coefficients are fixed before
...
/-- **Dimension-three class-first affine `H1` grid estimate.**
...
theorem h1_grid_unif
  ...
  have hgrid0 := DifferentialGeometry.PDE.RicciFlow.h2_grid_unif
    (E := E) (I := I) (M := M) hDim gBase hΛ
    g hEq hjet1 hjet2 P R hR hP2
  have hgrid3 := DifferentialGeometry.PDE.RicciFlow.h3_top_grid_unif
    (E := E) (I := I) (M := M) hDim gBase hΛ
