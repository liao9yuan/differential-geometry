...
This module converts the fixed-slice reduced-length estimate for one concrete
minimizing ray into a terminal-time-independent positive reduced-volume floor.
-/
...
/-- One concrete low-reduced-length minimizing ray at the later fixed slice
gives a positive reduced-volume floor uniform over the half-open terminal-time
interval. -/
