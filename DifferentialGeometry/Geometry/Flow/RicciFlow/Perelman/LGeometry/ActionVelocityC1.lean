...
/-!
# C1 chart velocity representatives

The continuous momentum bootstrap first gives a `C¹` chart position.  Smooth
dependence of the inverse chart Gram operator then upgrades the coordinate
velocity representative itself to `C¹`.
-/
...
/-- A `C¹` momentum representative and `C¹` chart position yield a `C¹`
coordinate-velocity representative through the genuine inverse Gram operator. -/
...
/-- A fixed-chart weak Euler identity with continuous force gives a `C¹`
coordinate-velocity representative and identifies it with the derivative
within the closed interval of the chart position. -/
