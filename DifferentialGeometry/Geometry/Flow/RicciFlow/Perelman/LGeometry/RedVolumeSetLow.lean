...
/-!
# Reduced-volume lower bound on a measurable set

This module contains the elementary set-level lower bound used by later
fixed-slice and smooth noncollapsing consumers.
-/
