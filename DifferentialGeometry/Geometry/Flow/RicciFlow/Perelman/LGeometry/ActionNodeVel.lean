...
/-!
# Velocity matching across an L-action chart node

The cross-chart momentum equation determines the coordinate velocity because
the fixed-chart metric Gram operator is invertible.
-/
...
/-- At a two-chart node of a fixed-endpoint L-action minimizer, the terminal
coordinate velocity of the left piece transports to the initial coordinate
velocity of the right piece. -/
