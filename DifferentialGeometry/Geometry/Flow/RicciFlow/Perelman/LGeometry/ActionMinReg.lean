...
A monotone finite chart realization of a fixed-endpoint minimizer is compressed
to positive pieces before the strict finite interior regularity theorem is
applied.
-/
