...
/-!
# Bounded initial data for regularized L-rays

This module combines compact-slab action, curvature, and ODE estimates to
bound the initial tangent vectors of a family of regularized L-rays.
-/
...
omit [InnerProductSpace Real E] [SigmaCompactSpace M] in
/-- A common positive existence interval and regularized L-action budget
uniformly bound the model norms of the initial tangents of L-rays. -/
