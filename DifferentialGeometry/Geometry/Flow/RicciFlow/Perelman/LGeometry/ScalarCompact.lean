...
omit [InnerProductSpace Real E] [NeZero (Module.finrank Real E)]
  [I.Boundaryless] [CompactSpace M] in
/-- On a compact time interval and a supplied compact target, the scalar part
of the regularized Lagrangian has a uniform lower bound. -/
...
omit [InnerProductSpace Real E] [NeZero (Module.finrank Real E)]
  [I.Boundaryless] [CompactSpace M] in
/-- The scalar part of the regularized L-action is continuous under uniform
convergence when all approximating curves have a supplied compact target. -/
