...
/-!
# Minimizing L-rays minimize regularized action

This module exposes the fixed-endpoint regularized-action minimality already
contained in membership in the minimizing L-exponential domain.
-/
...
/-- A minimizing L-exponential ray minimizes regularized action among all
global `C¹` curves with the same square-root-time endpoints. -/
