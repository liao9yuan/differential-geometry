...
/-!
# Adapted fields in the regularized L-index form

This file computes the regularized L-index density of the endpoint test field
obtained by linearly scaling a square-root-time adapted field.
-/
...
/-- Pointwise expansion of the regularized L-index density after multiplying
an adapted field by a differentiable real scalar. -/
...
omit [InnerProductSpace Real E] [NeZero (Module.finrank Real E)] in
/-- Pointwise Morgan--Tian expansion of the regularized L-index density for
the endpoint test field `W(s) = (s / b) P(s)` built from an adapted field. -/
...
omit [InnerProductSpace Real E] [NeZero (Module.finrank Real E)] in
/-- Morgan--Tian's single-field adapted-index identity for the endpoint test
field `W(s) = (s / b) P(s)`. -/
