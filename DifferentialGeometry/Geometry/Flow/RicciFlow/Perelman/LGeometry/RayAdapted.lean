...
/-!
# Adapted frames along canonical L-rays

This file globalizes a strict canonical L-ray near a positive compact segment
and constructs a common smooth terminal-orthonormal adapted frame along the
original ray.
-/
...
/-- A strict canonical L-ray admits a smooth terminal-orthonormal adapted
frame on one open neighborhood of every positive compact initial segment. -/
theorem exists_lRayAdapt
  ...
  · intro i j
    ...
    rw [← hbase b hbmem]
    simpa only [P, hRb i, hRb j] using hbasis i j
