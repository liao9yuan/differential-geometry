...
/-!
# Nullity of the conjugate L-cut image

This module combines the one-chart Euclidean Sard theorem with the generic
chart-null transfer and a finite chart cover of a compact manifold.
-/
...
/-- The conjugate part of the fixed-time L-cut image has zero Riemannian
volume for every smooth Riemannian metric on the compact manifold. -/
