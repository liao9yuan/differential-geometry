...
/-!
# Finite geometric assembly for regularized L-action density

This file lifts endpoint-flat coordinate approximants through finitely many
charts, glues them across a monotone subdivision, and proves uniform convergence
of the resulting manifold curves.
-/
...
/-- Endpoint-flat coordinate approximants on a finite monotone chart subdivision
assemble to global `C¹` manifold curves with fixed endpoints and uniform convergence. -/
theorem exists_c1_of_flat
  ...
  have hpieces_zero (n : Nat) :
    ...
    · have hm0 : m = 0 := Nat.eq_zero_of_not_pos hm
      ...
      simpa only [pieces, dif_neg hm] using
