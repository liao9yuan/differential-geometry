...
/-!
# Positive-start tail Laplacian comparison

This file traces the positive-start tail Hessian comparison against a supplied
terminal-orthonormal family of comparison fields.
-/
...
/-- The spatial Laplacian of a positive-start tail-action branch is bounded by
twice the trace of the regularized L-index over any terminal-orthonormal
comparison family. -/
