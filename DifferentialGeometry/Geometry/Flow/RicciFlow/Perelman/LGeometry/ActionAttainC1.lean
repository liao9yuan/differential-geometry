...
/-!
# C1 attainment of the relaxed regularized L-action

This module hides the finite chart-`H¹` realization returned by the direct
method after using it to prove closed-interval `C¹` regularity.
-/
...
/-- On a nondegenerate interval, the relaxed regularized L-action infimum is
attained by a `C¹` curve satisfying the genuine global fixed-endpoint `C¹`
competitor inequality. This does not assert `IsLRegCurveOn`. -/
