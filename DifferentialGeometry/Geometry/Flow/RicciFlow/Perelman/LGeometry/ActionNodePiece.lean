...
/-!
# Local minimality of a piece in an exact two-piece comparison

This file projects an exact fixed-endpoint comparison for two chart pieces to
local fixed-endpoint minimality of either individual piece.
-/
...
/-- Exact comparison of two chart pieces gives local fixed-endpoint
minimality of either piece. -/
