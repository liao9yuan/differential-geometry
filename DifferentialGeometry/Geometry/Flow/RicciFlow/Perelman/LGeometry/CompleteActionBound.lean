...
/-!
# Lower bounds for complete-flow regularized actions

This module converts a uniform Riemann-curvature bound on a regular backward
slab into a curve-independent lower bound for all fixed-endpoint global `C¹`
regularized L-actions.  Completeness is not needed for this lower-bound step.
-/
...
/-- Uniform Riemann curvature on a regular backward slab bounds below all
