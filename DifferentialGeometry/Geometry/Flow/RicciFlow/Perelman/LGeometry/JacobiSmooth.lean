...
/-!
# Smoothness of regularized L-Jacobi fields

This file records the total-space smoothness of the Jacobi field obtained by
differentiating the regularized L-geodesic with respect to its initial tangent
vector.
-/
...
/-- The initial-tangent regularized L-Jacobi field is jointly smooth in the
initial tangent vector and square-root time on the joint maximal domain. -/
