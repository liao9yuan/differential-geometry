...
/-!
# The fixed-chart C1-to-C2 bootstrap

A continuous representative of the weak chart velocity makes the genuine
nonlinear chart force continuous.  The actual weak Euler identity then upgrades
the velocity representative itself to `C¹`.
-/
...
/-- A fixed-chart weak `L`-Euler curve with a continuous weak-velocity
representative has a `C¹` coordinate-velocity representative. -/
