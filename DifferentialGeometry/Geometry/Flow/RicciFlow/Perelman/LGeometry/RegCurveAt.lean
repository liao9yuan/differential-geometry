...
/-!
# Intrinsic regularized L-curves at arbitrary base times

Local phase solutions through arbitrary regular times reconstruct intrinsic
curves with prescribed position and square-root-time velocity.
-/
...
/-- Prescribed position and square-root-time velocity at any regular base time
determine a local curve satisfying the intrinsic regularized L-acceleration
equation. -/
