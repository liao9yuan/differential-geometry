...
/-!
# Minimizing vectors to regular L-ray endpoints

This module supplies the existence input used when approaching an L-cut time
from above along a regular L-ray.
-/
...
/-- Every positive regular L-ray endpoint is reached by a minimizing initial
L-tangent at the same backward time. -/
