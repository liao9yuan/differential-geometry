...
/-!
# The conjugating diffeomorphism family of the DeTurck–Ricci flow

Packages the time-family of diffeomorphisms generated by the DeTurck vector field flow, which
conjugates the DeTurck-Ricci solution into a genuine Ricci-flow solution.
-/
