...
/-!
# Uniform curvature-jet compatibility layer (item-6 brick 2a)
...
The arbitrary-comparability order-zero producer now lives in the light
`UnifCurvatureSup` module. This compatibility layer retains the older metric-
difference realization, small-perturbation, and convex-path declarations.
-/
