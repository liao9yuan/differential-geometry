import DifferentialGeometry.Geometry.Compactness.CheegerGromov.ApproximateIsometry.ApproxIsoSeparationForward
...
noncomputable def compSepRev [I.Boundaryless] [NeZero (Module.finrank Real E)]
  ...
  have hc0''0 : 0 ≤ c0'' := by
    have hbase : 0 ≤ c0' + c0 * (1 + q) := by
      exact add_nonneg hc0'_nonneg (mul_nonneg hc0_nonneg (by linarith))
