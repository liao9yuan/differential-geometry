...
/-!
# Total mass from compactly supported convergence

This file gives the cutoff argument upgrading convergence against compactly
supported continuous real functions to convergence of total masses when the
measures have a common eventual exterior-tail bound.
-/
...
/-- Compactly supported test convergence and common eventual tightness imply convergence of
the total masses of finite measures. -/
theorem mass_tendsto_of_cc
    {X ι : Type*} [MeasurableSpace X] [TopologicalSpace X]
    [OpensMeasurableSpace X] [T2Space X] [R1Space X] [LocallyCompactSpace X]
