...
The chart-locality-free headline, keyed onto the chart-locality-free
chart-bilinear data
`eigenvectorTensorChartBilinearData g r s i α P₀` and the
...
`(eigenvectorTensorChartBilinearData g r s i α P₀).u_chart`. The
