...
/-- Quadratic energies converge when their essentially bounded coefficients converge
uniformly in essential operator norm and their time-`L²` inputs converge strongly. -/
