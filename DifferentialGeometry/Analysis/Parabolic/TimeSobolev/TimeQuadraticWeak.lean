...
/-- Quadratic energies with uniformly convergent essentially bounded coefficients are
lower semicontinuous along weakly convergent time-`L²` sequences. -/
...
/-- Quadratic energies are lower semicontinuous under weak convergence when their
essentially bounded coefficients converge uniformly in essential operator norm. -/
