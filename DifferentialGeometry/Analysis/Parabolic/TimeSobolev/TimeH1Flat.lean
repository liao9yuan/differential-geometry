...
/-- A time-`L²` function on a positive interval can be approximated strongly by a globally
smooth function whose support is contained in the open time interval. -/
