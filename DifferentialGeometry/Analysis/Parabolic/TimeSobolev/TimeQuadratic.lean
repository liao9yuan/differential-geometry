...
/-- The time-integrated quadratic form induced by an essentially bounded family of operators. -/
...
/-- The time quadratic form is nonnegative for an a.e. positive-semidefinite operator family. -/
...
/-- The time quadratic form is convex for an a.e. self-adjoint positive-semidefinite
operator family. -/
...
/-- The time quadratic form is lower semicontinuous for the weak topology on time `L²`. -/
