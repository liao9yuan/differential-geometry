...
/-! ## The heat coefficient and its elementary bounds -/
...
/-! ## Orthonormal `ℓ²`-isometry identity -/
...
/-! ## Operator-norm bound on the heat series -/
...
/-! ## Diagonal action on basis vectors -/
