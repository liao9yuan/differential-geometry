...
omit [CompleteSpace F] in
/-- A jointly `C¹` integrand on an open parameter-time neighborhood may be
differentiated with respect to the parameter under a compact interval integral. -/
...
/-- Compact-uniform convergence of interval averages along a shrinking real parameter. -/
