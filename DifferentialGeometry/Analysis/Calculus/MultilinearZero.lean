...
/-- At a time where a multilinear family vanishes, its evaluation on moving
slots has derivative given solely by differentiating the family. -/
theorem cml_deriv_zero {n : ℕ}
  ...
  simp only [ContinuousLinearMap.add_apply, ContinuousLinearMap.comp_apply,
    ...
    ContinuousMultilinearMap.zero_apply, Finset.sum_const_zero, add_zero]
