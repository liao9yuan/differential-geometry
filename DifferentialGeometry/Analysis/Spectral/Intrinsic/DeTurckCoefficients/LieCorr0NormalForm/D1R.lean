...
private theorem d1r_parts {n : ℕ} (ig cg f : Fin n → Fin n → ℝ)
    ...
    (ddg dga0 dga1 dgbg dgb : Fin n → Fin n → Fin n → Fin n → ℝ)
    (i j : Fin n) :
    d1RF ig cg f dg dig ga0 ga1 gbg gb f3 ddg dga0 dga1 dgbg dgb i j = d1rA ig cg f dg dig ga0 ga1 gbg gb f3 ddg dga0 dga1 dgbg dgb i j + d1rB ig cg f dg dig ga0 ga1 gbg gb f3 ddg dga0 dga1 dgbg dgb i j + d1rC ig cg f dg dig ga0 ga1 gbg gb f3 ddg dga0 dga1 dgbg dgb i j + d1rD ig cg f dg dig ga0 ga1 gbg gb f3 ddg dga0 dga1 dgbg dgb i j := rfl
...
private theorem d1rA_expand {n : ℕ} (ig cg f : Fin n → Fin n → ℝ)
  ...
  -((∑ b0, ∑ b3, ∑ b1, ∑ b2, ig b1 b2 * ga1 b1 b2 b0 * (ga0 b0 i b3 * f b3 j)) - (∑ b0, ∑ b3, ∑ b1, ∑ b2, ig b1 b2 * gbg b1 b2 b0 * (ga0 b0 i b3 * f b3 j))) + (-((∑ b0, ∑ b4, ∑ b1, ∑ b2, ig b1 b2 * ga1 b1 b2 b0 * (ga0 b0 j b4 * f i b4)) - (∑ b0, ∑ b4, ∑ b1, ∑ b2, ig b1 b2 * gbg b1 b2 b0 * (ga0 b0 j b4 * f i b4)))) := by
...
private theorem d1rD_expand {n : ℕ} (ig cg f : Fin n → Fin n → ℝ)
  ...
  (-((∑ b81, ∑ b82, ∑ b83, ∑ b84, ig b81 b82 * (ga1 j i b83 * (ga0 b83 b82 b84 * f b84 b81))) - (∑ b81, ∑ b82, ∑ b83, ∑ b84, ig b81 b82 * (ga0 j i b83 * (ga0 b83 b82 b84 * f b84 b81)))) + (-((∑ b81, ∑ b82, ∑ b83, ∑ b85, ig b81 b82 * (ga1 j i b83 * (ga0 b83 b81 b85 * f b82 b85))) - (∑ b81, ∑ b82, ∑ b83, ∑ b85, ig b81 b82 * (ga0 j i b83 * (ga0 b83 b81 b85 * f b82 b85)))))) := by
  simp only [d1rD, r3B]
