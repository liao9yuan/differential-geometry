...
private noncomputable def lieCorr0NEndo (g₀ g₁ g_bg : SmoothRiemannianMetric I M) (x : M) :
...
private theorem lieCorr0NEndo_homSection_contMDiff (g₀ g₁ g_bg : SmoothRiemannianMetric I M) :
...
private noncomputable def lieCorr0InsertFib (g₀ g₁ g_bg : SmoothRiemannianMetric I M) (x : M) :
...
private theorem lieCorr0InsertFib_toModel (g₀ g₁ g_bg : SmoothRiemannianMetric I M) (x : M)
...
private noncomputable def lieCorr0TraceStep (g : SmoothRiemannianMetric I M) (p : ℕ)
...
private def lieCorr0VBPerm : Equiv.Perm (Fin 4) :=
  ⟨![1, 2, 3, 0], ![3, 0, 1, 2], by decide, by decide⟩

private noncomputable def lieCorr0VBFib (g₀ g₁ : SmoothRiemannianMetric I M) (x : M) :
    Tensor0SSpace 2 I x →L[ℝ] Tensor0SSpace 2 I x :=
...
private def lieCorr0AMixPermQ : Equiv.Perm (Fin 5) :=
  ⟨![1, 4, 2, 3, 0], ![4, 0, 2, 3, 1], by decide, by decide⟩

private def lieCorr0AMixPerm1 : Equiv.Perm (Fin 6) :=
  ⟨![2, 0, 3, 1, 4, 5], ![1, 3, 0, 2, 4, 5], by decide, by decide⟩

private def lieCorr0AMixPerm2 : Equiv.Perm (Fin 4) :=
  ⟨![2, 0, 1, 3], ![1, 2, 0, 3], by decide, by decide⟩

private noncomputable def lieCorr0AMixHalfFib (g₀ g₁ g_bg : SmoothRiemannianMetric I M) (x : M) :
    Tensor0SSpace 2 I x →L[ℝ] Tensor0SSpace 2 I x :=
...
private noncomputable def lieCorr0AMixFib (g₀ g₁ g_bg : SmoothRiemannianMetric I M) (x : M) :
    Tensor0SSpace 2 I x →L[ℝ] Tensor0SSpace 2 I x :=
...
private noncomputable def lieCorr0RiemLoweredFib (g₀ : SmoothRiemannianMetric I M) (x : M) :
    Tensor0SSpace 4 I x :=
...
private def lieCorr0RiemPerm1 : Equiv.Perm (Fin 6) :=
  ⟨![1, 5, 2, 3, 4, 0], ![5, 0, 2, 3, 4, 1], by decide, by decide⟩

private def lieCorr0RiemPerm2 : Equiv.Perm (Fin 4) :=
  ⟨![2, 3, 0, 1], ![2, 3, 0, 1], by decide, by decide⟩

private noncomputable def lieCorr0RiemFib (g₀ g₁ : SmoothRiemannianMetric I M) (x : M) :
    Tensor0SSpace 2 I x →L[ℝ] Tensor0SSpace 2 I x :=
...
private theorem lieCorr0_prod_section_contMDiff {p q : ℕ}
...
private theorem lieCorr0TraceStep_section_contMDiff (g : SmoothRiemannianMetric I M) (p : ℕ)
...
private theorem lieCorr0RiemLoweredFib_section_contMDiff (g₀ : SmoothRiemannianMetric I M) :
...
private noncomputable def lieCorr0TotalFib (g₀ g₁ g_bg : SmoothRiemannianMetric I M) (x : M) :
    Tensor0SSpace 2 I x →L[ℝ] Tensor0SSpace 2 I x :=
...
private noncomputable def lieCorr0Field (g₀ g₁ g_bg : SmoothRiemannianMetric I M) :
...
private theorem lieCorr0Field_realizedFam_jointSmooth
    (hδ : gFibreOpBound (I := I) (M := M) g₀ (ccTensorBilinSymm (I := I) g₀ T) δ)
    (hδ' : gFibreOpBound (I := I) (M := M) g₀ (ccTensorBilinSymm (I := I) g₀ T') δ')
    (g_bg : SmoothRiemannianMetric I M) :
...
private theorem lieCorr0Phi0b_jointSmooth
    (hδ : gFibreOpBound (I := I) (M := M) g₀ (ccTensorBilinSymm (I := I) g₀ T) δ)
    (hδ' : gFibreOpBound (I := I) (M := M) g₀ (ccTensorBilinSymm (I := I) g₀ T') δ')
    (g_bg : SmoothRiemannianMetric I M) :
    linearizedRicciThreeArmHjoint (I := I) (M := M) g₀ 2
