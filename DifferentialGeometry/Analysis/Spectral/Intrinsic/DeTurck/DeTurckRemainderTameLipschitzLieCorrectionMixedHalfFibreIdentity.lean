...
lemma lc0b_amixhalf_fiber (g₀ g₁ g_bg : SmoothRiemannianMetric I M)
  ...
  rw [lc0AMixHalfField_toSection (I := I) (M := M) g₀ g₁ g_bg σlast x,
    ContinuousLinearMap.comp_apply]
  rw [lc0b_amix_outer_fiber (I := I) (M := M) g₀ g₁ g_bg x D]
  exact lc0Tr_fiber_apply (I := I) (M := M) g₀ g₁ 2 σlast x _
