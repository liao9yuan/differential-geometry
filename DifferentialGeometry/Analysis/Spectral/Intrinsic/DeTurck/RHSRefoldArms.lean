...
theorem rhsSlope_refold
  ...
  simp only [DifferentialGeometry.Analysis.Spectral.appCc]
  have hCoeff :
      DifferentialGeometry.Analysis.Spectral.DeTurckCoefficients.rhsLow0Coeff
          (I := I) (M := M) g g_bg T 0 hδ hδZ s =
        DifferentialGeometry.PDE.RicciFlow.IntrinsicSpectral.DeTurckCoefficients.rhsLow0Coeff
