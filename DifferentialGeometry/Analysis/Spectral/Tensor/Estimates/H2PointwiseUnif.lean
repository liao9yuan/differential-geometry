...
The curvature input `hcurv` is `UnifBochnerGap`'s abstract Weitzenböck-defect hypothesis; it
is discharged downstream by brick E3 from `MetricCovDerivOrderBoundOn`.
-/
