...
theorem traceViaBasis_c (G : E →ₗ[ℝ] E) :
...
theorem traceViaCometric_c (g₁ : SmoothRiemannianMetric I M) (x : M) (G : E →ₗ[ℝ] E) :
...
def alignedPrincipalEndoCZ (g₀ g₁ : SmoothRiemannianMetric I M) (S : SmoothCcTensor g₀ 0 2)
