...
set_option linter.unusedSectionVars false in
set_option linter.unusedVariables false in
/-- Metric-local compatibility wrapper for `invDiff_zero_unif`. -/
...
set_option linter.unusedSectionVars false in
set_option linter.unusedVariables false in
/-- Metric-local compatibility wrapper for `invDiff_slot_unif`. -/
...
set_option linter.unusedSectionVars false in
set_option linter.unusedVariables false in
/-- Metric-local compatibility wrapper for `invDiff_grid_unif`. -/
