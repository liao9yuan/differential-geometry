...
* `RfnsBilinearProduct.exists_rfns_iteratedCovGrad_prod_twoFactor_le` — the **`rfns` two-product jet
  grid**, with a nonnegative order-dependent constant uniform over the two factors and the base point.
