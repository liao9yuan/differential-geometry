...
lemma rfns_iCG_wEndoInsert_eq_wAlpha (g₀ g₁ g_bg : SmoothRiemannianMetric I M)
    (i : ℕ) (x : M) :
  ...
  rw [deTurckLieWEndoInsert_eq_cometricRaise_wAlpha (I := I) (M := M) g₀ g₁ g_bg]
  exact rfns_iteratedCovGrad_cometricRaiseSlot0Field_eq (I := I) (M := M) g₀ 0
    (wAlpha (I := I) (M := M) g₀ g₁ g_bg) i x

lemma norm_iCG_wEndoInsert_eq_wAlpha (g₀ g₁ g_bg : SmoothRiemannianMetric I M)
    (i : ℕ) :
    ‖iteratedCovGrad (I := I) g₀ 1 1 i
